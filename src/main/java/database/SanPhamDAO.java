...
public class SanPhamDAO implements DAOInterface<SanPham> {
	...
	public SanPham selectById(SanPham t) {
		...
		try {
			...
			System.out.println(t.getMaSanPham());
//			System.out.println(sql);
	...
	public int insert(SanPham t) {
		...
		try {
			...
			String sql = "INSERT INTO sanpham (masanpham,tensanpham, matacgia, namxuatban,"
					+ " gianhap, giagoc, giaban, soluong, matheloai, ngonngu, mota, anhbia) "
					+ " VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
	...
	public int update(SanPham t) {
		...
		try {
			...
			String sql = "UPDATE sanpham " + " SET " + "tensanpham=?, matacgia=?, namxuatban=?, gianhap=?, giagoc=?, "
					+ "giaban=?, soluong=?, matheloai=?, ngonngu=?, mota=?, anhbia=?" + " WHERE masanpham=?";
