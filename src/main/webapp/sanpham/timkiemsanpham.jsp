		...
		<div class="row d-flex justify-content-around">
			...
			<span class="visually-hidden">Next</span>
				...
				<div class="row">
					...
					<%
						ArrayList<SanPham> sp_list = (ArrayList<SanPham>) request.getAttribute("results");
					 ...
					 %>
					 	...
					 	<div class="col-lg-3 col-md-6 mb-4">
							<div class="card h-100">
								<a href="san-pham?hanhDong=chi-tiet-san-pham&maSanPham=<%= sanPham.getMaSanPham() %>"><img class="card-img-top" src="<%=sanPham.getAnhBia() %>"
									alt=""></a>
								<div class="card-body">
									<h5 class="card-title">
